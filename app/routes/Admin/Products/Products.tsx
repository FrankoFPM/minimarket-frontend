...
import { getProductos, createProducto, updateProducto, deleteProducto, getProductoById } from '~/services/productosService'
...
function ModalActions({ producto, onSuccess }: ModalActionsProps) {
